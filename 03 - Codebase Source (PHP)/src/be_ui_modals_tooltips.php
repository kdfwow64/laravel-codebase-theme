...
<div class="content">
    ...
    <!-- For advanced poover usage you can check out https://getbootstrap.com/docs/4.3/components/tooltips/ -->
    ...
    <!-- For advanced poover usage you can check out https://getbootstrap.com/docs/4.3/components/popovers/ -->
    ...
    <!-- For all modal methods you can check out https://getbootstrap.com/docs/4.3/components/modal/#via-javascript -->
